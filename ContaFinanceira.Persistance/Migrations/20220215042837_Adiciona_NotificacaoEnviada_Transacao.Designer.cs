...
namespace ContaFinanceira.Persistance.Migrations
{
    ...
    [Migration("20220215042837_Adiciona_NotificacaoEnviada_Transacao")]
    partial class Adiciona_NotificacaoEnviada_Transacao
    {
            ...
            modelBuilder.Entity("ContaFinanceira.Domain.Entities.Conta", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            Senha = "$2a$11$jk.wJ7hPVnyrCf5BYRJ5PekeQscvKKfNkvi15nh4/zgp4ekmj19C."
                        });
                });
